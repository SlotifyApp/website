...
export function WeeklyCalendar({
  ...
  // Calculate fractional hour value (including partial hours)
  ...
  // For a given day, return the list of suggestion slots (potential events)
    ...
    <div className='w-full'>
      ...
      <div className='grid grid-cols-[60px_repeat(7,1fr)] pl-5'>
        ...
        {days.map((day, index) => (
          ...
          >
            <div className={cn(format(day, 'yyyy-MM-dd') === format(new Date(), 'yyyy-MM-dd') ? 'bg-focusColor/90 text-white rounded-xl' : '')}>
